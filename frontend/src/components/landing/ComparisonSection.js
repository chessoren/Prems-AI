...
const rows = [
  { criteria: "Temps de réaction", manual: "2 à 4 heures", prems: "< 60 secondes" },
  { criteria: "Couverture", manual: "SeLoger / Leboncoin", prems: "+350 sites d'agences en direct" },
  { criteria: "Effort", manual: "2h / jour", prems: "0 min / jour" },
  { criteria: "Résultat", manual: "«Déjà loué»", prems: "«Visite confirmée»" }
];
        ...
        <FadeIn>
          <div className="text-center mb-16 pt-8">
            ...
            <p className="text-neutral-400 max-w-xl mx-auto">
              Dans une zone tendue, la vitesse est le seul critère qui compte vraiment.
            </p>
          </div>
        </FadeIn>
        ...
        <ScaleIn delay={0.2}>
          <div className="rounded-2xl border border-neutral-800 overflow-hidden bg-neutral-900/50 backdrop-blur">
            <div className="grid grid-cols-3 border-b border-neutral-800">
              <div className="p-5 text-neutral-400 font-semibold text-sm">Critères</div>
            ...
            {rows.map((row, i) => (
              <div key={i} className="grid grid-cols-3 border-b border-neutral-800/50 last:border-b-0 hover:bg-neutral-800/20 transition-colors" data-testid={`comparison-row-${i}`}>
                <div className="p-5"><span className="text-white font-semibold text-sm">{row.criteria}</span></div>
