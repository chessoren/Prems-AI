        ...
        <FadeIn>
          <div className="text-center mb-16">
            ...
            <p className="text-neutral-500 max-w-lg mx-auto">
              Une offre simple. Sans engagement. Arrêtez dès que vous avez trouvé.
            </p>
          </div>
        </FadeIn>
          ...
          {plans.map((plan, i) => (
            <ScaleIn key={i} delay={i * 0.15}>
              <div
                ...
                className={`relative bg-white rounded-2xl border p-8 transition-all hover:shadow-xl h-full flex flex-col ${plan.popular ? 'border-orange-200 shadow-lg shadow-orange-100/40' : 'border-neutral-200 hover:border-neutral-300'}`}
              >
                {plan.popular && (
                ...
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-8 h-8 rounded-lg bg-orange-50 flex items-center justify-center">{plan.icon}</div>
